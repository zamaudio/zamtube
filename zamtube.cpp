...
class ZamTube : public Plugin<ZamTube> { 
public:
	Triode v;
	V Vi;
	C Ci;
	...
	ZamTube(double rate) : Plugin<ZamTube>(8), 
...
static int _ = ZamTube::register_class("http://zamaudio.com/lv2/zamtube");
